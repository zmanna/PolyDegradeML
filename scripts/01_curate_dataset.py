...
from biodegradation_ml_framework.data import CURATED_DATA_PATH, DEFAULT_DATA_PATH, build_curated_qsar_dataset
...
def main() -> None:
    ...
    metadata = {
        ...
        "source_path": project_relative(DEFAULT_DATA_PATH),
        "curated_path": project_relative(CURATED_DATA_PATH),
    ...
    report = f"""# Dataset Curation and Representation
...
## Dataset Version
- Version: `v1`
- Source file: `{project_relative(DEFAULT_DATA_PATH)}`
- Curated file: `{project_relative(CURATED_DATA_PATH)}`
