...
from biodegradation_ml_framework.models import run_qsar_classification_baselines


PROJECT_ROOT = Path(__file__).resolve().parents[1]
REPORTS_DIR = PROJECT_ROOT / "reports"
RESULTS_METADATA_DIR = PROJECT_ROOT / "results" / "metadata"
METRICS_PATH = RESULTS_METADATA_DIR / "baseline_model_metrics.json"
REPORT_PATH = REPORTS_DIR / "baseline_modeling.md"
...
def main() -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "## Extension To Regression Targets",
