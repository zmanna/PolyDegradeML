...
from .environment_validation import build_proxy_environments_for_arrays
from .feature_engineering import build_feature_engineering_bundle
from .feature_selection import build_selected_feature_sets, compute_feature_rankings
...
def _build_feature_map(*, random_state: int = 42) -> UncertaintyFeatureMap:
    ...
    return UncertaintyFeatureMap(feature_frames=feature_frames, y_binary=bundle.y_binary)
...
def write_uncertainty_charts(
    ...
    *,
    ...
    fig.tight_layout()
    calibration_path = output_path / "calibration_curve.png"
    ...
    fig.tight_layout()
    selective_path = output_path / "selective_accuracy.png"
    ...
    ax.set_title("Uncertainty on Correct vs Incorrect Predictions")
    ax.set_ylabel("Mean uncertainty")
    ax.set_xticks(x)
    ax.set_xticklabels(uncertainty_df["feature_set"], rotation=20, ha="right")
    ax.legend()
    fig.tight_layout()
    uncertainty_path = output_path / "uncertainty_correct_vs_incorrect.png"
