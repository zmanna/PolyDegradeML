...
def run_cross_validation_for_arrays(
    X: np.ndarray,
    y: np.ndarray,
    *,
    random_state: int = 42,
...
def run_cross_validation(*, random_state: int = 42) -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    return run_cross_validation_for_arrays(X, y, random_state=random_state)
